...
// Supporting classes that would need to be created:
...
// ActiveTask.java - JPA Entity

// ActiveTaskRepository.java - Spring Data JPA Repository


// GoalExtractionService.java - Service interface
